...
###<a id="varImpSection">Predictor Importance</a>
...
32 predictors were used in the final predicton model this could be further reduced using the **varImp** (Variable Importance) method as seen [above] (#varImpSection), thus reducing the accuracy - which will get rid of the overfitting, and processing time.  
